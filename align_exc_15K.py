...
if __name__ == '__main__':
    # EN_DE_15K_V1, EN_FR_15K_V1, fr_en(dbp15), ja_en(dbp15)#+
    datasets = 'EN_FR_15K_V2/'
    run(datasets, link_version='4/', model_type='M-path', fileName='E(7.23)tt')
    #run(datasets, link_version='2/', model_type='E', fileName='E(7.23)')
    #run(datasets, link_version='3/', model_type='E', fileName='E(7.23)')
    #run(datasets, link_version='4/', model_type='M', fileName='E(7.23)')
